...
[select* select id:select  "אבוקדו" "אבטיח – חממות" "אבטיח מללי" "אבטיח- שטח פתוח" "אגוזי אדמה" "אגס" "אנונה" "אננס" "אספסת" "אספרגוס" "אפונה" "אפרסמון" "אפרסק" "ארטישוק" "בטטה" "בננה" "בצל יבש" "בצל ירוק" "בקיה" "ברוקולי" "גויאבה" "גזר" "גפן ליין" "גפן למאכל" "דובדבן" "דוחן" "דלורית" "דלעת" "הדרים" "זית" "חבוש" "חוחובה" "חיטה" "חמניות" "חמצה" "חסה" "חציל- חממות" "חציל- שטח פתוח" "כוסברה" "כותנה" "כרוב" "כרובית" "כרישה" "ליצי" "לפת" "מלון- חממות" "מלון- שטח פתוח" "מלפפון" "מנגו" "משמש" "משתלה" "נקטרינה" "סורגום" "סיטריה" "סלק" "סלרי" "עגבניות- חממות" "עגבניות- שטח פתוח" "פטל" "פטרוזיליה" "פלפל- חממות" "פלפל- שטח פתוח" "פסיפלורה" "פקאן" "פרחים- חממות" "פרחים- שטח פתוח" "צנון" "צנונית" "קולורבי" "קיווי" "קישוא חממות" "קישוא- שטח פתוח" "רימון" "שום" "שומר" "שזיף" "שטחי בור" "שיבולת שועל" "שמיר" "שסק" "שעועית" "שעורה" "שקד" "תאנים" "תבלינים חממות" "תבלינים- שטח פתוח" "תות שדה" "תירס" "תלתן" "תמר" "תפוא" "תפוח" "תרד" ]
// reapit acf
...
//  acf галерея
<?php $slider=get_field('news_slider');
if($slider){
            ...
            <?php if( get_sub_field('менеджера') ): ?>
                <?php while( has_sub_field('менеджера') ): ?>
                    <div class="item-contacts">
                        ...
                        <?php if( get_sub_field('телефони') ): ?>
                            <?php while( has_sub_field('телефони') ): ?>
                                <div class="phone-block"><a href="tel:<?php echo get_sub_field('телефон');?>"><?php echo get_sub_field('телефон');?></a></div>
                            <?php endwhile; ?>
                        <?php endif; ?>
                    </div>
                <?php endwhile; ?>
